...
def text_to_voice(text_data, to_language):
    ...
    os.system("mpg321 cache_file.mp3")  # Use mpg321 for audio playback on Unix-like systems
    ...
    if start_button:
        ...
        with sr.Microphone() as source:
            while True:
                ...
                audio = rec.listen(source, phrase_time_limit=5)  # Set a short phrase limit for continuous capture

                try:
                    # Convert audio to text in the source language
